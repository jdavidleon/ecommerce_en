...
<!-- banner -->
	<div class="banner">	
		...
		<div class="w3l_banner_nav_right">
			...
			<!-- flexSlider -->
				<link rel="stylesheet" href="<?php echo ASSETS ?>css/flexslider.css" type="text/css" media="screen" property="" />
				<script defer src="<?php echo ASSETS ?>js/jquery.flexslider-min.js"></script>
				...
				<div class="col-md-4 wthree_banner_bottom_left">
					<div class="wthree_banner_bottom_left_grid">
						...
						<div class="wthree_banner_bottom_left_grid_pos">
							<h4>Ofertas de <br> locura <span>25%</span></h4>
						</div>
					</div>
				</div>
				<div class="col-md-4 wthree_banner_bottom_left">
		...
		<div class="container">
			...
			<div class="agile_top_brands_grids">
				...
				<?php 
					...
					$where = 'productos_publicados.estado_publicado = ? AND productos.tm_delete IS NULL AND (productos_agotados.estado_agotado = ? || productos_agotados.estado_agotado IS NULL)';
					$params = ['ss','SI','NO'];
					$order = 'productos_descuento.porcentaje DESC';
					$productos_ofertas = Products::cargarProductos($rows,$where,$params); 
					usort($productos_ofertas, 'sort_by_orden');
					function sort_by_orden ($a, $b) {
					    return $a['porcentajeDescuento'] < $b['porcentajeDescuento'];
					}

					for ($i=0; $i < 4 ; $i++) { 
						$imprimir_ofertas[$i] = $productos_ofertas[$i];
					}

					imprimirProducto($imprimir_ofertas); 
				?>
		...
		<div class="container">
			...
			<div class="agile_top_brands_grids">
				<?php 
					...
					$productos_ofertas = Products::cargarProductos($rows,$where,$params,$order,4); 
					imprimirProducto($productos_ofertas); 
				?>
				<div class="clearfix"> </div>
			</div>
		</div>
